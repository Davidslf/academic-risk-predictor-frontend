...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-usb-canvas flex flex-col">
      ...
      <section className="relative bg-ar-gradient overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-5 py-20 md:py-28 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <motion.h1 {...fadeUp(0.08)} className="text-4xl md:text-5xl font-extrabold text-white leading-tight mb-4">
              Hola, {firstName}.<br />
              <span className="text-ar-cyan">Predice tu éxito</span><br />
              académico
            </motion.h1>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-5xl mx-auto px-5">
          <motion.div {...fadeUp()} className="text-center mb-12">
            ...
            <h2 className="text-3xl font-extrabold text-usb-text mt-2">Todo lo que necesitas para mejorar</h2>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <motion.div
                key={f.title}
                {...fadeUp(i * 0.08)}
                className="bg-usb-canvas rounded-2xl p-6 border border-usb-border hover:shadow-card-hover hover:-translate-y-1 transition-all"
              >
      ...
      <section className="py-20 bg-usb-canvas">
        <div className="max-w-4xl mx-auto px-5">
          <motion.div {...fadeUp()} className="text-center mb-12">
            ...
            <h2 className="text-3xl font-extrabold text-usb-text mt-2">Tres pasos simples</h2>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-5">
          <motion.div {...fadeUp()} className="text-center mb-12">
            ...
            <h2 className="text-3xl font-extrabold text-usb-text mt-2">¿Qué analiza el predictor?</h2>
          </motion.div>
      ...
      {/* ── CTA banner ───────────────────────────────────────────────────── */}
      <section className="py-16 bg-ar-gradient">
        <div className="max-w-2xl mx-auto px-5 text-center">
          <motion.div {...fadeUp()}>
            <Clock size={32} className="text-ar-cyan mx-auto mb-4" />
            <h2 className="text-3xl font-extrabold text-white mb-3">Menos de 1 minuto</h2>
      ...
      <footer className="bg-ar-navy border-t border-white/10 py-6 text-center">
        ...
        <p className="text-white/30 text-xs">Plataforma académica multi-institucional · Período 2024-I</p>
        <div className="flex items-center justify-center gap-2 mt-3">
          {['Python', 'FastAPI', 'scikit-learn', 'React', 'TypeScript'].map(t => (
            <span key={t} className="text-[0.65rem] font-bold uppercase tracking-wider text-white/20 bg-white/5 px-2 py-0.5 rounded-full border border-white/10">
              {t}
            </span>
          ))}
        </div>
